...
public class MeasureRamp extends AppCompatActivity {
    ...
    private Rampas ramp = new Rampas(null, null, null, null, null, null, null, null, null);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sk_height_control.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                ramp.setAlturaPasamanosSuperior((float) progress * 100);
            }
                ...
                (HitResult hitResult, Plane plane, MotionEvent motionEvent) -> {
                    ...
                    if (anchor1 == null) {
                        ...
                        if (!measuring_width) {
                            ...
                            confirm.setEnabled(true);
                            ramp.setLongitud(getMetersBetweenAnchors(anchor1, anchor2) * 100);
                        } else {
                            ramp_width.setText("Anchura rampa: " +
                                    form_numbers.format(getMetersBetweenAnchors(anchor1, anchor2)));
                            ramp.setAnchura(getMetersBetweenAnchors(anchor1, anchor2) * 100);
